...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 29, 2025 at 10:27 AM
...
(1, 'ADMIN001', '$2b$10$EcFjNP6eKgRT2v8e0XrghedWNV0cZSTezYRLj85PeGPwkP3wVh8bG', 'System Administrator', NULL, 'admin', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, 0, '2025-10-26 15:14:01', '2025-10-29 08:50:40', '2025-10-29 08:50:40'),
...
(3, '2021-00002', '$2b$10$GQODgr.C/G7HUxbb7RM5ae0ZsXbkMetVmsbBtXsQ4ZptpEzRbMGLG', 'Maria Elena', 'mariaelena@gmail.com', 'student', 'BSIT', NULL, 3, NULL, NULL, NULL, 1, 1, 0, '2025-10-29 09:12:51', '2025-10-29 09:12:51', NULL);
...
CREATE TRIGGER `enforce_max_genres_per_user` BEFORE INSERT ON `user_genres` FOR EACH ROW BEGIN
  ...
  IF genre_count >= 3 THEN
    ...
    SET MESSAGE_TEXT = 'User cannot have more than 3 genre preferences';
  END IF;
END
$$
DELIMITER ;
...
(1, 3, 5, '2025-10-29 09:12:51'),
(2, 3, 6, '2025-10-29 09:12:51'),
(3, 3, 22, '2025-10-29 09:12:51');
